        ...
        <nav className="bg-black py-3 fixed top-0 w-full z-50">
            <div className="container px-4 mx-auto md:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <ul className={`menu text-white bg-gradient-to-b from-black to-gray-800 top-0 ${isOpen ? 'left-0 lg:left-2/3 lg:w-1/3' : 'left-[110%]'} absolute h-screen w-screen flex flex-col justify-center -z-10 duration-500 ease-in-out drop-shadow-xl lg:drop-shadow-2xl`}>
                        {
                            navLink.map(({id, link}) => (
