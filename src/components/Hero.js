...
const Hero = () => {
    return (
        <section name="home" className="bg-gradient-to-b from-black to-gray-800 pt-24 pb-20 md:py-20 w-full">
            <div className='container mx-auto px-4 md:px-8'>
                
                {/* Hero Text */}
                <div className="hero-text text-white md:text-center">
                    ...
                    <p className='mt-4 mb-8'>I am a professional web developer with more than two years of experince. I create web application using React JS, Node JS, Express JS, MonogDB, and Bootstrap or Tailwind.</p>
