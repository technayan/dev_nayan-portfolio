    ...
    return (
        <section className='about-section py-14 bg-gradient-to-b from-gray-800 to-black md:py-20'>
            <div className="container px-4 mx-auto md:px-10">
                ...
                <div className="md:flex md:gap-10 md:items-center lg:gap-0">
                    <div className='md:order-2'>

                        {/* Profile Image */}
                        <img src={ProfileImg} className='mb-14 w-2/3 mx-auto md:ml-auto border-4 border-blue-600 md:w-full md:my-auto lg:w-4/5' alt="Abdullah Nayan" />
                    </div>
                    <div className='md:order-1'>
                        ...
                        {/* About Action Button */}
                        <button className='mt-10 px-6 py-2 bg-blue-600 hover:bg-blue-700 duration-300 font-medium text-lg lg:px-8 text-white'>Contact</button>
                    </div>
                </div>
            </div>
        </section>
